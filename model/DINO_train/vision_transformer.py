...
from model.DINO_train.utils import trunc_normal_
...
def vit_small(pretrained=False, patch_size=16, **kwargs):
    model = VisionTransformer(
        patch_size=patch_size, embed_dim=384, depth=12, num_heads=6, mlp_ratio=4,
        qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    variant = "vit_small_patch16_224"
    vit_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, global_pool='avg')
