...
from model.HIPT.model_utils import *

import sys
from model.HIPT.HIPT_4K.vision_transformer4k import vit4k_xs
    ...
    def __init__(self, path_input_dim=384,  size_arg = "small", dropout=0.25, n_classes=4,
     pretrain_4k='None', freeze_4k=False, pretrain_WSI='None', freeze_WSI=False):
        ...
        if pretrain_4k != 'None':
            ...
            state_dict = torch.load('/scratch/iq24/cc0395/HIPT/HIPT_4K/Checkpoints/%s.pth' % pretrain_4k, map_location='cpu')['teacher']
