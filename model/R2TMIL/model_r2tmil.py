...
from model.R2TMIL.modules.emb_position import *
from model.R2TMIL.modules.datten import *
from model.R2TMIL.modules.rmsa import *
from model.R2TMIL.modules.nystrom_attention import NystromAttention
...
class RRTMIL(nn.Module):
    def __init__(self, input_dim=1024, mlp_dim=512, act='relu', n_classes=2, dropout=0.25, pos_pos=0, pos='none',
                 ...
                 da_dropout=False, trans_dim=64, epeg=True, min_region_num=0, qkv_bias=True, **kwargs):
        ...
        self.online_encoder = RRTEncoder(mlp_dim=mlp_dim, pos_pos=pos_pos, pos=pos, peg_k=peg_k, attn=attn,
