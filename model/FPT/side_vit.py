        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                if fine_grained_prompts is not None:
                    prompted_states = torch.cat([hidden_states, fine_grained_prompts], dim=1)
                    layer_outputs = layer_module(prompted_states, layer_head_mask, output_attentions)
                    prompted_states, attention_prob = layer_outputs[0], layer_outputs[1:]
...
class ViTForImageClassification(ViTPreTrainedModel):
    ...
    def forward(
        ...
        # print('sequence_output:', sequence_output[:, 0, :].size())
